...
class SyncV1BFSWalkTestCase(BaseBFSWalkTestCase):
    __test__ = True
...
class SyncV2BFSWalkTestCase(BaseBFSWalkTestCase):
    __test__ = True
...
class SyncBridgeBFSWalkTestCase(SyncV2BFSWalkTestCase):
    _enable_sync_v1 = True
...
class SyncV1DFSWalkTestCase(BaseDFSWalkTestCase):
    __test__ = True
...
class SyncV2DFSWalkTestCase(BaseDFSWalkTestCase):
    __test__ = True
...
# sync-bridge should behave like sync-v2
class SyncBridgeDFSWalkTestCase(SyncV2DFSWalkTestCase):
    _enable_sync_v1 = True
