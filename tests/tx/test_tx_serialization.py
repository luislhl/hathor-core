...
class SyncV1NoSerializationTest(BaseNoSerializationTest):
    __test__ = True
...
class SyncV2NoSerializationTest(BaseNoSerializationTest):
    __test__ = True
...
class SyncBridgeNoSerializationTest(SyncV2NoSerializationTest):
    _enable_sync_v1 = True
...
class SyncV1StructSerializationTest(BaseStructSerializationTest):
    __test__ = True
...
class SyncV2StructSerializationTest(BaseStructSerializationTest):
    __test__ = True
...
# sync-bridge should behave like sync-v2
class SyncBridgeStructSerializationTest(SyncV2StructSerializationTest):
    _enable_sync_v1 = True
...
class SyncV1ProtobufSerializationTest(BaseProtobufSerializationTest):
    __test__ = True
...
class SyncV2ProtobufSerializationTest(BaseProtobufSerializationTest):
    __test__ = True
...
# sync-bridge should behave like sync-v2
class SyncBridgeProtobufSerializationTest(SyncV2ProtobufSerializationTest):
    _enable_sync_v1 = True
