...
class SyncV1BlockchainTestCase(BaseBlockchainTestCase):
    __test__ = True
...
class SyncV2BlockchainTestCase(BaseBlockchainTestCase):
    __test__ = True
...
class SyncBridgeBlockchainTestCase(SyncV2BlockchainTestCase):
    _enable_sync_v1 = True
