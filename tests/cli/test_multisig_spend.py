...
class SyncV1MultiSigSpendTest(BaseMultiSigSpendTest):
    __test__ = True
...
class SyncV2MultiSigSpendTest(BaseMultiSigSpendTest):
    __test__ = True
...
class SyncBridgeMultiSigSpendTest(SyncV2MultiSigSpendTest):
    _enable_sync_v1 = True
