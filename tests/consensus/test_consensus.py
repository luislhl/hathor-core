...
class SyncV1ConsensusTestCase(BaseConsensusTestCase):
    __test__ = True
...
class SyncV2ConsensusTestCase(BaseConsensusTestCase):
    __test__ = True
...
class SyncBridgeConsensusTestCase(SyncV2ConsensusTestCase):
    _enable_sync_v1 = True
