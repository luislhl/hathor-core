...
class SyncV1HathorProtocolTestCase(BaseHathorProtocolTestCase):
    __test__ = True
...
class SyncV2HathorProtocolTestCase(BaseHathorProtocolTestCase):
    __test__ = True
...
class SyncBridgeHathorProtocolTestCase(SyncV2HathorProtocolTestCase):
    _enable_sync_v1 = True
