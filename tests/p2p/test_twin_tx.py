...
class SyncV1TwinTransactionTestCase(BaseTwinTransactionTestCase):
    __test__ = True
...
class SyncV2TwinTransactionTestCase(BaseTwinTransactionTestCase):
    __test__ = True
...
class SyncBridgeTwinTransactionTestCase(SyncV2TwinTransactionTestCase):
    _enable_sync_v1 = True
