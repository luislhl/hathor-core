...
class SyncV1NetfilterMatchTest(BaseNetfilterMatchTest):
    __test__ = True
...
class SyncV2NetfilterMatchTest(BaseNetfilterMatchTest):
    __test__ = True
...
class SyncBridgeNetfilterMatchTest(SyncV2NetfilterMatchTest):
    _enable_sync_v1 = True
