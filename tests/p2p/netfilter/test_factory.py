...
class SyncV1NetfilterFactoryTest(BaseNetfilterFactoryTest):
    __test__ = True
...
class SyncV2NetfilterFactoryTest(BaseNetfilterFactoryTest):
    __test__ = True
...
class SyncBridgeNetfilterFactoryTest(SyncV2NetfilterFactoryTest):
    _enable_sync_v1 = True
